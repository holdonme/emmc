...
card_size()
{
cmd8 | busybox grep SEC_COUNT: > /log/temp11.log
...
cmd8 | busybox grep PARTITION_SETTING_COMPLETED: > /log/temp5.log
awk -F ' ' '{print $2}' /log/temp5.log > /log/temp6.log
read erase_group < /log/temp6.log
if [ $erase_group -eq 0 ]; then

cmd8 | busybox grep HC_ERASE_GP_SIZE: > /log/temp5.log
awk -F ' ' '{print $2}' /log/temp5.log > /log/temp6.log
read erase_group < /log/temp6.log
((erase_group_size=$erase_group))
rm temp*.log

cmd8 | busybox grep HC_WP_GRP_SIZE: > /log/temp5.log
awk -F ' ' '{print $2}' /log/temp5.log > /log/temp6.log
