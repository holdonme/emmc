...
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m  -I 
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m -r512 -I 
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m -r1k -I 
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m -r2k -I 
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m -r4k -I 
./iozone -+n -ec -i0 -i1 -i2 -t16 -s ${test_size}m -r8k -I 
fi
}
...
./iozone -+n -wec -i0 -i1 -i2  -t16 -d2000 -s ${test_size}m   
./iozone -+n -wec -i0 -i1 -i2  -t16 -d2000 -s ${test_size}m -r512  
