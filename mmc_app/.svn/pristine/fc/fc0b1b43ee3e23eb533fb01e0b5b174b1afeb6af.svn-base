...
int huawei_pl_task(int count, char *cmd_buf, uint8_t *write_buf, uint8_t *read_buf, int len)
{
	...
	printf("\n\n********* [index %d] STEP_2. power-loss when run CMD_1 ********\n\n", count);
...
void help_menu(void)
{
	printf("Usage: huawei -d NUM -s NUM [-n NUM]\n");
	printf("       huawei -d NUM -v NUM [-n NUM]\n");
	printf("Options:\n"); 
